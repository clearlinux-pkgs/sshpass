...
Version  : 1.10
Release  : 6
URL      : https://mirrors.kernel.org/debian/pool/main/s/sshpass/sshpass_1.10.orig.tar.gz
Source0  : https://mirrors.kernel.org/debian/pool/main/s/sshpass/sshpass_1.10.orig.tar.gz
...
%prep
%setup -q -n sshpass-1.10
cd %{_builddir}/sshpass-1.10
pushd ..
cp -a sshpass-1.10 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1712330689
